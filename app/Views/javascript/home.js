   ...
   $.ajax({
      ...
      success: function (data) {
         ...
         for (i = 0; i < data.length; i++) {
            $('#category-container').append("<a class='cat-link' href='/topic/" + data[i].cat_name.toLowerCase() + "'><li value=\"" + data[i].cat_id + "\"  style=\'border-bottom: 0.5px solid lightgrey\; border:0.5px solid lightgrey;border-left: 10px solid" + colors[i] + ";' " +
               ...
               "            <p class=\"topic-num\">"+data[i].cat_topics+"</p>\n" +
               "        </div>\n" +
